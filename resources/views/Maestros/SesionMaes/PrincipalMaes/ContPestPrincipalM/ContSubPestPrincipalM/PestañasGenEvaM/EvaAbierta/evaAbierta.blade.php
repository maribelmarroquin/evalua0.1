			...
			<div class="panel-body">
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						{!! Form::open(['route' => ['maestros00001.generaAbierto.show', $asignatura->clave_asig], 'method' => 'GET']) !!}
						<tr>
							<td>
							...
							<td>
								...
								{!! Form::submit( $uni->unidad .'.- '.  $uni->nom_uni , ['class' => 'btn btn-default btn-lg btn-block', 'style'=>'background-color:#09C; color:#fff;']) !!}
							</td>
						</tr>
						{!! Form::close() !!}
						@endforeach
