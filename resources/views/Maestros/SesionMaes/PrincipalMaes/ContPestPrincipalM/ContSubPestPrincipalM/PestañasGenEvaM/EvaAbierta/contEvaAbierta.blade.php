...
{{-- ------------------------------Generar Evaluacion Resuelto------------------------------------ --}}
		<div class="col-md-6 col-md-offset-3" >
			...
			@include('Maestros.SesionMaes.PrincipalMaes.ContPestPrincipalM.ContSubPestPrincipalM.PestañasGenEvaM.EvaAbierta.impEvaResAbierto')
	{{-- ------------------------------Generar Evaluacion Sin Resolver------------------------------------ --}}
				@include('Maestros.SesionMaes.PrincipalMaes.ContPestPrincipalM.ContSubPestPrincipalM.PestañasGenEvaM.EvaAbierta.impEvaAbierta')
